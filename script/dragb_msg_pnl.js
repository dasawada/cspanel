(function(global) {
  ...
  function showPasswordPrompt(callback) {
    ...
    mask.innerHTML = `
      <div style="background:#fff;padding:32px 40px;border-radius:8px;box-shadow:0 2px 16px #0002;text-align:center;">
        <h2 style="margin-bottom:16px;">請輸入密碼</h2>
        <input id="pw-input" type="password" style="font-size:18px;padding:6px 12px;width:220px;" autofocus />
        <button id="pw-btn" style="font-size:18px;margin-left:10px;">登入</button>
        <div id="pw-err" style="color:red;margin-top:10px;height:22px;"></div>
      </div>
    `;
